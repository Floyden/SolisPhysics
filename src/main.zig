...
pub fn main() !void {
    ...
    _ = world.addCollider(Collider.Collider2D{ .shape = rect1Shape, .transform = transform, .mass = 1.0 });
    _ = world.addCollider(Collider.Collider2D{ .shape = rect2Shape, .transform = transform, .mass = 1.0 });
